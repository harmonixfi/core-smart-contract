...
contract Solv is IERC721Receiver, ReentrancyGuard {
    ...
    //get openFundShareId
    function getOpenFundShareId(address userAddress, uint256 tokenId) external view returns (address) {
        return user[userAddress].openFundShareId[tokenId];
    }
    ...
    function onERC721Received(
        ...
        console.log("NINVB => receiver NFT ", tokenId);
        user[msg.sender].tokenId = tokenId;
