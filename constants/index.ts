...
export const KYBER_SWAP_ROUTER_ADDRESS: { [key in CHAINID]?: string } = {
  [CHAINID.ETH_MAINNET]: "0x6131B5fae19EA4f9D964eAc0408E4408b66337b5",
  [CHAINID.ARBITRUM_MAINNET]: "0x6131B5fae19EA4f9D964eAc0408E4408b66337b5",
  [CHAINID.BASE_MAINNET]: "0x6131B5fae19EA4f9D964eAc0408E4408b66337b5",
};

export const KYBER_SWAP_AGGREGATOR_ADDRESS: { [key in CHAINID]?: string } = {
  [CHAINID.ETH_MAINNET]: "",
  [CHAINID.ARBITRUM_MAINNET]: "0x86c3F3910824bE34fF46C1D5C70c6a59E88894d2",
};
...
export const WBTC_IMPERSONATED_SIGNER_ADDRESS: { [key in CHAINID]?: string } = {
  [CHAINID.ARBITRUM_MAINNET]: "0x9DD9C2D208B07Bf9A4eF9CA311F36d7185749635",
};

export const RSETH_IMPERSONATED_SIGNER_ADDRESS: { [key in CHAINID]?: string } =
  {
    [CHAINID.ARBITRUM_MAINNET]: "0x89266C44Ba52745e4eD9C3A8346A721A4Ef0736A",
  };
...
export const SOLV_ADDRESS: { [key in CHAINID]?: string } = {
  [CHAINID.ARBITRUM_MAINNET]: "0x629aD7Bc14726e9cEA4FCb3A7b363D237bB5dBE8",
};

export const POOL_SOLV_WBTC: { [key in CHAINID]?: string } = {
  [CHAINID.ARBITRUM_MAINNET]:
...
export const PY_YT_LP_ORACLE: { [key in CHAINID]?: string } = {
  [CHAINID.ARBITRUM_MAINNET]: "0x9a9Fa8338dd5E5B2188006f1Cd2Ef26d921650C2",
};

export const PENDLE_ALL_ACTION_V3: { [key in CHAINID]?: string } = {
  [CHAINID.ARBITRUM_MAINNET]: "0x888888888889758F76e7103c6CbF23ABbF58F946",
};
